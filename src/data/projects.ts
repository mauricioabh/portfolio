...
export const projects: Project[] = [
  {
    ...
    longDescription:
      "Built a full-stack manga tracking platform with Next.js, TypeScript, and NeonDB. Features user authentication with Clerk and automated email notifications with Resend. Implemented data validation and wrote end-to-end tests with Playwright.",
  ...
  },
  {
    ...
    longDescription:
      "Developed a PDF summarization tool using Next.js and Google Gemini AI. Handles file uploads with UploadThing, manages user subscriptions through Stripe, and stores data in NeonDB. Added smooth animations with Framer Motion.",
