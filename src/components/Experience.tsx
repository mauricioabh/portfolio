...
const experiences: ExperienceItem[] = [
  {
    ...
    technologies: ["SAP Ecosystem", "Enterprise Web", "Cloud", "JavaScript", "UI5", "Remote"],
    current: false,
  },
  {
    id: "onibex",
    ...
    technologies: ["Node.js", "DocumentDB", "OData", "SAP Gateway", "ABAP", "REST APIs", "SAP"],
    current: false,
  },
  {
    id: "dainda",
    ...
    technologies: ["ColdFusion", "JavaScript", "HTML", "CSS", "Sybase", "Remote"],
    current: false,
  },
  {
    id: "bitam",
    company: "BITAM de México",
    ...
    technologies: ["PHP", "MySQL", "JavaScript", "jQuery", "Bootstrap", "PhoneGap/Cordova", "iOS"],
    current: false,
  },
  {
    id: "bitam-qa",
